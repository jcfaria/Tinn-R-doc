...
\begin{itemize}
  ...
  \item From this version Tinn-R will be released in three flavours: \texttt{Tinn-R}, \texttt{Tinn-RPortable} and
    compatible with \texttt{PortableApps platform}.
  \item Some files of the folder \texttt{utils} were updated to meet with \texttt{Tinn-RPortable} project necessities.
