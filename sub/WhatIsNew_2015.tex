...
\hypertarget{2015}{}
\section{Versions released in 2015 (03)}
\index{What is New?!2015}

\subsection*{4.0.3.4 (Mai/25/2015)}
\begin{itemize}
  \item Bug(s) fixed:
    \begin{itemize}
      ...
      \item A bug related to \texttt{Update R mirrors} and the countries \texttt{Gemany, Spain and Sweden} was fixed.
    \end{itemize}
  \item The versions 4.0.3.1, 4.0.3.2 and 4.0.3.3 were restrict to testers: thanks for tests and sugestions.
  \item The \texttt{TinnRcom} package was updated to the version 1.0.18.
  \item Some files of the folder \texttt{utils} were updated to meet with \texttt{Tinn-RPortable} project (in development) necessities.
    Therefore, the folders and files of the R variable \texttt{.trPaths} were changed to \texttt{TEMP} environment variable.
...
\begin{itemize}
  \item Bug(s) fixed:
    \begin{itemize}
      ...
      \item The file \texttt{Rinstall.R} located at the folder \texttt{utils} where Tinn-R is instaled was updated to supress
...
\begin{itemize}
  \item Bug(s) fixed:
    \begin{itemize}
      ...
      \item Some bugs were fixed related to Hide/Show resources os \texttt{Tools panel}
    \end{itemize}
