...
\begin{itemize}
  \item Features Added:
    \begin{itemize}
      ...
      \item An experimental Hex viewer (\htmladdnormallink{ATBinHex}{http://atviewer.sourceforge.net/atbinhex.htm}) was added to \texttt{Tools/Results/Hex viewer}. A bug is related to the UTF-8 BOM encoding file: the selection of (Char $\rightleftharpoons$ Hex), only in the first line, is not correctly associating the character with its corresponding Hex. It has its own pop-up menu with many (and useful) options.
