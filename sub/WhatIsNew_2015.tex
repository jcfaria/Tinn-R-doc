...
\subsection*{4.0.3.8 (ago/11/2015)}
\begin{itemize}
  \item The versions 4.0.3.6 and 4.0.3.7 were restrict to testers: thanks for tests and suggestions.
  \item The menu options has a new option: \texttt{R echo (on/off)}. It enables the user to choice if want (or not)
    echo some options of send: file, selection, clipboard, block marked, contiguous lines a line to end of page. The
    default shortcut is \texttt{ALT + E}. We think it made more simple and user friendly these options.
  \item The procedure to open a remote file from an URL was improved and now cover also \texttt{https} protocol.
