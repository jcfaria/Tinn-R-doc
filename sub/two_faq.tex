...
\index{installation!source code}
...
\index{installation!saving preferences}
...
\index{installation!starting GUI}
...
\index{installation!default editor}
...
\index{installation!Emacs}
\index{installation!WinEdt}
...
\index{hotkeys!defining hotkeys}
...
\index{hotkeys!shortcut for cycling}
...
\index{find errors in my script using Rterm interface}
...
\index{comunication between Tinn-R and Rgui freeze}
