...
\subsubsection\textbf{.paths? (a very recorrent FAQ)}\\
\index{FAQ!.paths?}
\index{.paths?}
...
\subsubsection{What does "Args and data" mean in Options/Application/R/General/Basic?}\\
\index{FAQ!triggers}
\index{triggers}

\includegraphics[scale=.50]{./res/app_r_basic_completion_history.png}
...
\includegraphics[scale=.36]{./res/dlg_skh_map_rh_send.png}
\includegraphics[scale=.36]{./res/dlg_skh_map_rh_control.png}
\includegraphics[scale=.36]{./res/dlg_skh_map_rh_custom.png}
...
\includegraphics[scale=.50]{./res/dlg_highlighter_settings.png}
...
\subsubsection{How can I find errors in my script using Term interface?}\\
