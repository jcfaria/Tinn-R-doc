...
\index{database!shortcuts}
\index{dataset!shortcuts}
...
\index{database!keystrokes}
\index{dataset!keystrokes}

\begin{figure}[H]
  \includegraphics[scale=0.35]{./res/dlg_skh_map_keystrokes.png}\\
...
\subsection{Hotkeys (dataset - send R)}
\index{Hotkeys send (R)}
\index{database!hotkeys send (R)}
\index{dataset!hotkeys send (R)}
...
\subsection{Hotkeys (dataset - control R)}
\index{Hotkeys control (R)}
\index{database!hotkeys control (R)}
\index{dataset!hotkeys control (R)}
...
\subsection{Hotkeys (dataset - custom R)}
\index{Hotkeys custom (R)}
\index{database!hotkeys custom (R)}
\index{dataset!hotkeys custom (R)}
