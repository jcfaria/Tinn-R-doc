...
\includegraphics[scale=0.60]{./res/tools_r_explorer.png}
...
\includegraphics[scale=0.60]{./res/tools_database_snippets.png}~~
\includegraphics[scale=0.60]{./res/tools_database_comments.png} \\

\paragraph{}\textbf{Snippets}\\
\index{secrets!database!snippets}
...
%\includegraphics[scale=0.50]{./res/tools_database_snippets.png}
