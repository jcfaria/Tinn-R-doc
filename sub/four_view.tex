...
\begin{scriptsize}\begin{tabularx}{\textwidth}{>{\hsize=0.7\hsize}X>{\hsize=0.7\hsize}X}\\
    ...
    Line wrap (show/hide) & \textit{\htmladdnormallink{See options ...}{\#menu\_view\_wordwrap}} \\
...
\begin{scriptsize}\begin{tabularx}{\textwidth}{>{\hsize=0.7\hsize}X>{\hsize=0.7\hsize}X}\\
    ...
    Line wrap & \textit{\htmladdnormallink{See options ...}{\#menu\_r\_rterm\_wordwrap}} \\
...
\hypertarget{menu_view_r_rterm_syntax_IO}{}
\subsubsection{Syntax IO}\\
\index{view menu!Rterm syntax IO}
...
\index{view menu!Rterm syntax Log}
...
\hypertarget{menu_view_r_rterm_wordwrap}{}
...
\hypertarget{menu_view_wordwrap}{}
