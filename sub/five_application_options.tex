...
\includegraphics[scale=0.50]{./res/app_main_view.png}
...
\includegraphics[scale=0.35]{./res/app_processing_latex_dvi.png}~~
\includegraphics[scale=0.35]{./res/app_processing_latex_pdf.png}~~
\includegraphics[scale=0.35]{./res/app_processing_latex_more.png}\\
